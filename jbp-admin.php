...
<body>
    <div id="admin-ui" class="container col-md-6 rounded-bottom py-3 my-md-3">
        ...
        <hr>
        <main class="">
            <h3 id="tipo-usuario">Ejecutivo: <span id="nombre-usuario"></span></h3>
            <hr>

            <div class="input-group mb-3">
                <span class="input-group-text"><i class="icon-user"></i> Cliente</span>
                <input id="cliente" class="btn btn-outline-dark" data-bs-toggle="modal" data-bs-target="#clientes-registrados" value="" placeholder="Seleccionar cliente" readonly>
            </div>
            ...
            <!-- MODAL CLIENTES -->
            <div class="modal fade" id="clientes-registrados" tabindex="-1" role="dialog" aria-labelledby="modalTitleId" aria-hidden="true">
